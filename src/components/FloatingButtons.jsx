  ...
  return (
    <div className="fixed bottom-6 right-4 md:right-6 z-50 flex flex-col items-end gap-3">
      ...
      <AnimatePresence>
        {scrolled && (
          <motion.button
            ...
            onClick={scrollToTop}
            className="w-12 h-12 bg-[#3b82f6] rounded-full flex items-center justify-center text-white shadow-lg hover:bg-[#2563eb] transition-colors cursor-pointer"
      ...
      <motion.a
        ...
        target="_blank"
        rel="noreferrer"
        className="w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center text-white shadow-[0_0_20px_rgba(37,211,102,0.3)] hover:bg-[#1ebd57] transition-colors cursor-pointer"
      >
